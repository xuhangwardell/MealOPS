...
public class MealPlanController {
 ...
 public record SlotResponse(LocalDate date,MealType mealType,SelectionResponse recipeSelection){ static SlotResponse from(MealSlot s){return new SlotResponse(s.date(),s.mealType(),s.recipeSelection()==null?null:SelectionResponse.from(s.recipeSelection()));} }
